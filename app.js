...
//сабміт кінець//
    ...
    if (doorBtn) {
        ...
        const achievements = {
            ...
            50: "Досягнення #2:\nВ розробці 🕝. Ви постукали у двері Валківської Приймальні 50 разів.",
            ...
            888: "Досягнення #9:\nМамин езотерик 🔮\nВи постукали у двері Валківської Приймальні 888 разів — згідно нумерології це число нескінченного багатства і успіху, а також кількість разів, коли можна було вже зупинитись і зайнятись чимось кориснішим.",
            1000: "Досягнення #10:\nВи постукали у двері Валківської Приймальні 1000 разів. Ваш приз — ви можете додати 5 власних валківських артефактів у цей додаток. Сфоткайте щось у місті. Відправляти сюди: @valkyshobot 👈🏻",
            2000: "Досягнення #11:\nБотяра якийсь.\nВи постукали у двері Валківської Приймальні 2000 раз. Ну ви або зовсім таво або проходьте капчу. Ми ще не придумали приз.",
            2345: "Досягнення #12:\nАномалія. Ви абсолютно унікальні. Цього не мало статися. Ви постукали у двері Валківської Приймальні рівно 2345 рази. Ми цього не планували. Доведеться придумувати ще щось.",
        ...
        const names = ["Юля", "Оля", "Віка", "Каріна", "Лєна", "Свєта", "тьоть Валя", "ота бабуля", "Аня", "Настя", "Даша", "Оксана", "Марина"];
        const names2 = ["Саня", "Дімон", "Влад", "Оля", "Каріна", "ота дивна дівчина", "отой странний чувак", "Таня", "тьоть Таня", "Макс", "Ігорьок", "дядя Толя", "той тіп з центру", "Настя", "Ріта", "Наташа", "Даша", "Ліза", "Серьога", "Артем", "Денчик", "Жека", "Рома"];
        const predictions = [
